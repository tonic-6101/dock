<!--
  ...
  Single bookmark tile — 4px top border in app color, label (2 lines),
  muted section, × to remove (hover), drag handle when editMode=true.
-->
<script lang="ts">
...
<template>
  <div
    ...
    :style="{ borderTopColor: bookmark.color || 'var(--dock-accent)' }"
